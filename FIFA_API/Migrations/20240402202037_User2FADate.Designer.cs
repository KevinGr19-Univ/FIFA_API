...
namespace FIFA_API.Migrations
{
    ...
    [Migration("20240402202037_User2FADate")]
    partial class User2FADate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FIFA_API.Models.EntityFramework.Auth2FALogin", b =>
                {
                    ...
                    b.Property<string>("Code")
                        ...
                        .HasColumnName("a2f_code");

                    b.Property<DateTime>("Date")
                        .HasColumnType("timestamp without time zone")
                        .HasColumnName("a2f_date");

                    b.HasKey("IdUtilisateur");

                    b.ToTable("t_e_auth2falogin_a2f");
                });

            modelBuilder.Entity("FIFA_API.Models.EntityFramework.AuthEmailVerif", b =>
                {
                    b.Property<int>("IdUtilisateur")
                        .HasColumnType("integer")
                        .HasColumnName("utl_id");
                    ...
                    b.Property<string>("Code")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("aev_code");

                    b.Property<DateTime>("Date")
                        .HasColumnType("timestamp without time zone")
                        .HasColumnName("aev_date");
            ...
            modelBuilder.Entity("FIFA_API.Models.EntityFramework.AuthPasswordReset", b =>
                {
                    ...
                    b.HasIndex("Code")
                        .IsUnique()
                        .HasDatabaseName("IX_authpasswordreset_apr_code");
            ...
            modelBuilder.Entity("FIFA_API.Models.EntityFramework.Commande", b =>
                {
                    ...
                    b.Property<string>("CodePostalFacturation")
                        ...
                        .HasColumnName("cmd_codepostalfacturation")
                        .IsFixedLength();
                    ...
                    b.Property<string>("CodePostalLivraison")
                        ...
                        .HasMaxLength(5)
                        .HasColumnType("character(5)")
                        .HasColumnName("cmd_codepostallivraison")
                        .IsFixedLength();
                    ...
                    b.Property<string>("RueFacturation")
                        ...
                        .HasColumnName("cmd_ruefacturation");

                    b.Property<string>("RueLivraison")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("cmd_ruelivraison");
                    ...
                    b.Property<string>("VilleFacturation")
                        ...
                        .HasColumnName("cmd_villefacturation");

                    b.Property<string>("VilleLivraison")
                        .IsRequired()
                        .HasMaxLength(150)
                        .HasColumnType("character varying(150)")
                        .HasColumnName("cmd_villelivraison");
                    ...
                    b.HasCheckConstraint("ck_cmd_codepostalfacturation", "cmd_codepostalfacturation ~ '^([0-9]{2}|2[AB])[0-9]{3}$'");
            ...
            modelBuilder.Entity("FIFA_API.Models.EntityFramework.Couleur", b =>
                {
                    ...
                    b.Property<bool>("Visible")
                        ...
                        .HasColumnType("boolean")
                        .HasDefaultValue(true)
                        .HasColumnName("col_visible");

                    b.HasKey("Id");

                    b.ToTable("t_e_couleur_col");

                    b.HasCheckConstraint("ck_col_codehexa", "col_codehexa ~ '^[0-9A-Fa-f]{6}$'");
                });
            ...
            modelBuilder.Entity("FIFA_API.Models.EntityFramework.ThemeVote", b =>
                {
                    ...
                    b.Property<string>("NomTheme")
                        ...
                        .HasColumnName("thv_nomtheme");

                    b.Property<bool>("Visible")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true)
                        .HasColumnName("thv_visible");

                    b.HasKey("Id");

                    b.HasIndex("NomTheme")
                        .IsUnique()
                        .HasDatabaseName("IX_themevote_thv_nomtheme");
            ...
            modelBuilder.Entity("FIFA_API.Models.EntityFramework.Utilisateur", b =>
                {
                    ...
                    b.Property<DateTime?>("DateVerif2FA")
                        .HasColumnType("timestamp without time zone")
                        .HasColumnName("utl_dateverif2fa");
                    ...
                    b.Property<string>("RefreshToken")
                        .HasColumnType("text")
                        .HasColumnName("utl_refreshtoken");
                    ...
                    b.HasIndex("Token2FA")
                        .IsUnique()
                        .HasDatabaseName("IX_utilisateur_utl_token2fa");

                    b.ToTable("t_e_utilisateur_utl");

                    b.HasCheckConstraint("ck_utl_telephone", "utl_telephone ~ '^(0|\\+33)[1-9][0-9]{8}$'");
                });
            ...
            modelBuilder.Entity("FIFA_API.Models.EntityFramework.VoteUtilisateur", b =>
                {
                    ...
                    b.Property<int>("IdJoueur1")
                        .HasColumnType("integer")
                        .HasColumnName("jou_id1");

                    b.Property<int>("IdJoueur2")
                        .HasColumnType("integer")
                        .HasColumnName("jou_id2");

                    b.Property<int>("IdJoueur3")
                        .HasColumnType("integer")
                        .HasColumnName("jou_id3");

                    b.HasKey("IdUtilisateur", "IdTheme");

                    b.HasIndex("IdJoueur1")
                        .HasDatabaseName("IX_voteutilisateur_jou_id1");

                    b.HasIndex("IdJoueur2")
                        .HasDatabaseName("IX_voteutilisateur_jou_id2");

                    b.HasIndex("IdJoueur3")
                        .HasDatabaseName("IX_voteutilisateur_jou_id3");

                    b.HasIndex("IdTheme")
                        .HasDatabaseName("IX_voteutilisateur_thv_id");
            ...
            modelBuilder.Entity("t_j_joueurpublication_jop", b =>
                {
                    ...
                    b.HasKey("JoueursId", "PublicationsId");

                    b.HasIndex("PublicationsId")
                        .HasDatabaseName("IX_joueurpublication_pub_id");

                    b.ToTable("t_j_joueurpublication_jop");
                });
            ...
            modelBuilder.Entity("FIFA_API.Models.EntityFramework.AuthEmailVerif", b =>
                {
                    b.HasOne("FIFA_API.Models.EntityFramework.Utilisateur", "Utilisateur")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_authemailverif_utl_id");
            ...
            modelBuilder.Entity("FIFA_API.Models.EntityFramework.VoteUtilisateur", b =>
                {
                    b.HasOne("FIFA_API.Models.EntityFramework.Joueur", "Joueur1")
                        .WithMany()
                        .HasForeignKey("IdJoueur1")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("FK_voteutilisateur_jou_id1");

                    b.HasOne("FIFA_API.Models.EntityFramework.Joueur", "Joueur2")
                        .WithMany()
                        .HasForeignKey("IdJoueur2")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("FK_voteutilisateur_jou_id2");

                    b.HasOne("FIFA_API.Models.EntityFramework.Joueur", "Joueur3")
                        .WithMany()
                        .HasForeignKey("IdJoueur3")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("FK_voteutilisateur_jou_id3");

                    b.HasOne("FIFA_API.Models.EntityFramework.ThemeVote", "ThemeVote")
                        .WithMany()
                        .HasForeignKey("IdTheme")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("FK_voteutilisateur_thv_id");
            ...
            modelBuilder.Entity("t_j_joueurpublication_jop", b =>
                {
                    b.HasOne("FIFA_API.Models.EntityFramework.Joueur", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_joueurpublication_jou_id");
                    ...
                    b.HasOne("FIFA_API.Models.EntityFramework.Publication", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_joueurpublication_pub_id");
                });
            ...
            modelBuilder.Entity("FIFA_API.Models.EntityFramework.Couleur", b =>
                {
                    b.Navigation("VariantesProduits");
                });
