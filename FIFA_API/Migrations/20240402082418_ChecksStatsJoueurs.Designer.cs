...
namespace FIFA_API.Migrations
{
    ...
    [Migration("20240402082418_ChecksStatsJoueurs")]
    partial class ChecksStatsJoueurs
    {
            ...
            modelBuilder.Entity("t_j_joueurpublication_jop", b =>
                {
                    ...
                    b.Property<int>("_publicationsId")
                        .HasColumnType("integer")
                        .HasColumnName("pub_id");

                    b.HasKey("JoueursId", "_publicationsId");

                    b.HasIndex("_publicationsId")
