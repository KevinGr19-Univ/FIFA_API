...
namespace FIFA_API.Migrations
{
    ...
    [Migration("20240320135058_AddVoteTheme")]
    partial class AddVoteTheme
    {
            ...
            modelBuilder.Entity("FIFA_API.Models.EntityFramework.VoteUtilisateur", b =>
                {
                    ...
                    b.HasKey("IdUtilisateur", "NomTheme");
                    ...
                    b.HasIndex("NomTheme")
                        .HasDatabaseName("IX_voteutilisateur_thv_nomtheme");
            ...
            modelBuilder.Entity("FIFA_API.Models.EntityFramework.VoteUtilisateur", b =>
                {
                    ...
                    b.HasOne("FIFA_API.Models.EntityFramework.ThemeVote", "ThemeVote")
                        .WithMany()
                        .HasForeignKey("NomTheme")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("FK_voteutilisateur_thv_nomtheme");
